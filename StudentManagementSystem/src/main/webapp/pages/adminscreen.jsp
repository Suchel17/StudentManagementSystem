...
<body>
	...
	<div class="card">
		<nav class="d-flex justify-content-between p-2 border border-primary" >
			<img src="images/cjclogo.png" width="150px" height="50px">
				<div class="pt-2">
					<a href="#enroll">
 						...
 						<h3 class="heading">Student Enrollment Form</h3>
 								...
 								<form action="enroll_student">
 									<div class="row " >
										<div class="col-md-6 mb-2">
 											<div class="form-outline">
 												<input type="text" id="firstName" class="form-control form-control-sm" name="studentFullNam"/>
 									...
 									<div class="col-md-6 mb-2 pb-2">
 										<div class="form-outline">
 											<input type="text" id="college" class="form-control form-control-sm" name="studentCollageName"/>
 											<label  class="form-label" for="college" >Student Collage Name</label>
 										</div>
									</div>
									</div>
